...
def build_data_health():
    ...
    rows.append(_row('FII / DII institutional flow',DATA/'market_intelligence'/'fii_dii.csv','NSE official FII/FPI & DII activity','OFFICIAL/PROVISIONAL',36,120,'Last verified institutional-flow cache','Same-day NSE values are provisional; final FPI reference is NSDL/CDSL.'))
