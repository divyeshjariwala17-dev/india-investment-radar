...
KEEP_DATA=[
    ...
    'alerts.csv','cross_asset.csv','cross_asset_history.csv','google_archive_settings.json','source_registry.csv','source_runtime.json','fd_rates.csv','small_savings_rates.csv','mf_universe.csv','cloud_sync_status.json'
]
KEEP_DIRS=['dashboard_cache','mutual_funds','mf_histories','crypto','macro','market_intelligence','vault']
